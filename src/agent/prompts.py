...
INFO_PROMPT = """You are doing web search on people, {people}.
...
You have just scrated website content. Your task is to take clear, organized notes about a person, focusing on topics relevant to our interests.
...
Remember: Don't try to format the ouput to match the schema - just take clear notes that capture all relevant infomation.
"""
